...
public class Get_All_User_Media_Info_Client extends Client
{
    public Get_All_User_Media_Info_Client(String server_ip,
                                          String server_port,
                                          String user_name,
                                          String user_password)
    {
        req_url =   API_Tags.HTTP + server_ip + ":" + server_port +
                API_Tags.GET_ALL_USER_MEDIA_INFO +
    ...
    //return json object
    //[{USR_NAME: u_name, MED_NAME: m_name, MED_TIME: m_time, MED_LOC: m_loc}
